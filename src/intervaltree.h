/* This is the interval tree library provided by Erik Garrison on
 * GitHub: https://github.com/ekg/intervaltree
 * Since it is a very simple and self-contained header-only library, it was included
 * by copying it instead of using CPMPackage or any other mechanism
 */
